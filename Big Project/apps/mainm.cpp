...
double absolute_difference2( double *p_a , double *p_b )
{
        ...
        double absDiff = absolute(*p_a - *p_b);
        return absDiff;
}
...
// Your explanation: because in this function we copied the value of the variables in the main and put it in a and b.
// so a and b have the variables values but the are not connected to them and when i make a change in a and b the original variables willnot change.
// s swap3 is useless
